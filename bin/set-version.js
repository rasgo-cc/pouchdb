...
var jsonFiles = packages.map(function (pkg) {
  ...
  path.resolve(__dirname, '../packages/node_modules/@rasgo/pouchdb/component.json'),
  path.resolve(__dirname, '../packages/node_modules/@rasgo/pouchdb/bower.json'),
...
var versionFile = path.resolve(__dirname,
  '../packages/node_modules/@rasgo/pouchdb-core/src/version.js');
