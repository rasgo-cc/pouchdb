        ...
        var throughStream = through(function (entry, _, next) {
          ...
          function allDocsInner(data) {
            ...
            if (opts.include_docs) {
              if (!data) {
                // shouldn't happen but it can happen
                // if data has been currupted
                // https://github.com/pouchdb/pouchdb/issues/4936
                // return next(); // can't reproduce :(
              }
              doc.doc = data;
  ...
  api._close = function (callback) {
    ...
    db.close(function (err) {
      ...
      if (err) {
        ...
        var viewNamePrefix = name + "-mrview-";
